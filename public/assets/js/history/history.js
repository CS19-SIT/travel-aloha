...
var htmlContent_3 = '</h6></div></span><span class="right"><div class="child"><a href="#"><button type="button" class="btn-link">View details</button></a></div></span><span class="icon"><div class="book-icon"><img src="';
